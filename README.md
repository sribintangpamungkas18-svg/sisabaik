...
-	Memeriksa kontras, fokus keyboard, reflow, dan konsistensi visual. ## Halaman
...
-	`styles.css`: sistem visual dan layout responsif untuk seluruh halaman. ## Menjalankan proyek
